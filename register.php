...
<div class="form-register">
	...
	<br>
      ...
      <input name= "name" type="text" placeholder="Masukkan Nama"><br>
	  <label for = "lemail">Email	</label><br>
      <input name= "email" type="email" placeholder="Masukkan Email"><br>
	  <label for = "uname">Username	</label><br>
      <input name= "uname" type="text" placeholder="Masukkanr Username"><br>
	  <label for = "pass">Password	</label><br>
      <input name= "pass" type="password" placeholder="Masukkan password"><br><br>
